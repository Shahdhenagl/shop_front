...
import { formatPrice, getProductBadgeKind, getProductBadgeLabel, getProductBrand, getProductSalesScore, isBestSeller, isInStock, isInstallable, readIds, saveIds } from "@/lib/store";
...
export default function SearchResults() {
  ...
  const [favoriteBusyIds, setFavoriteBusyIds] = useState<number[]>([]);
