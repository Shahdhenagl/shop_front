...
import { formatPrice, getProductBrand, isInStock, isInstallable, readIds, saveIds } from "@/lib/store";
...
export default function SearchResults() {
  ...
  }).sort((a, b) => sort === "low" ? a.price - b.price : sort === "high" ? b.price - a.price : a.id - b.id), [products, query, category, brand, stockFilter, min, max, sort, installableOnly]);
